...
const commonTheme = {
  ...
  brandedGradient: 'linear-gradient(139.57deg, #f26522 4.35%, #f29822 96.44%);',
...
export const lightTheme: Theme = {
  ...
  accentActionSoft: opacify(12, colors.orange400),
  accentActiveSoft: opacify(24, colors.blue400),
  ...
  networkDefaultShadow: `0px 40px 120px ${opacify(12, colors.orange400)}`,
